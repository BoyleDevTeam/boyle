...
auto RouteLineQuinticOffsetModel::setHardBorders(std::span<const HardBorder2d> hard_borders
) noexcept -> void {
...
auto RouteLineQuinticOffsetModel::setSoftBorders(std::span<const SoftBorder2d> soft_borders
) noexcept -> void {
