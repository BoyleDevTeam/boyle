...
auto RouteLineQuinticOffsetModel::settings() const noexcept -> const ::boyle::math::OsqpSettings& {
    return m_settings;
}
...
auto RouteLineQuinticOffsetModel::solve() const -> RouteLineQuinticOffsetModel::Result {
    ...
    const std::vector<::boyle::math::Vec2d> anchor_points =
        ::boyle::math::squeeze<::boyle::math::Vec2d>(
    ...
    return RouteLineQuinticOffsetModel::Result{
