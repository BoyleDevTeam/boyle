  ...
  public:
    ...
    auto setInitialState(
        ...
        m_qp_problem.updateConstrainTerm(
            yIndex(0),
            ::boyle::math::pmr::DokVector<scalar_type, index_type>{
                {{yIndex(0), 1.0}}, get_allocator()
            },
            r0.y - ::boyle::math::kEpsilon, r0.y + ::boyle::math::kEpsilon
        );
        if (!std::isnan(t0.y)) {
            m_qp_problem.updateConstrainTerm(
                m_num_samples * 8,
    ...
    auto setFinalState(
        ...
        // m_qp_problem.updateConstrainTerm(
        //     d4xIndex(m_num_samples - 1),
        //     ::boyle::math::pmr::DokVector<scalar_type, index_type>{
        //         {{d4xIndex(m_num_samples - 1), 1.0}}, get_allocator()
        //     },
        //     std::numeric_limits<scalar_type>::lowest(), std::numeric_limits<scalar_type>::max()
        // );
        ...
        // m_qp_problem.updateConstrainTerm(
        //     d4yIndex(m_num_samples - 1),
        //     ::boyle::math::pmr::DokVector<scalar_type, index_type>{
        //         {{d4yIndex(m_num_samples - 1), 1.0}}, get_allocator()
        //     },
        //     std::numeric_limits<scalar_type>::lowest(), std::numeric_limits<scalar_type>::max()
        // );
        return;
  ...
  private:
    auto setIntegrationRelation() noexcept -> void {
        for (index_type i{1}; i < m_num_samples - 1; ++i) {
            ...
            m_qp_problem.updateConstrainTerm(
                m_num_samples * 6 + i, constrain_vec, -::boyle::math::kEpsilon,
                ::boyle::math::kEpsilon
            );
            constrain_vec = boyle::math::pmr::DokVector<scalar_type, index_type>{
            ...
            m_qp_problem.updateConstrainTerm(
                m_num_samples * 7 + i, constrain_vec, -::boyle::math::kEpsilon,
                ::boyle::math::kEpsilon
            );
            constrain_vec = boyle::math::pmr::DokVector<scalar_type, index_type>{
            ...
            m_qp_problem.updateConstrainTerm(
                m_num_samples * 8 + i, constrain_vec, -::boyle::math::kEpsilon,
                ::boyle::math::kEpsilon
            );
            constrain_vec = boyle::math::pmr::DokVector<scalar_type, index_type>{
            ...
            m_qp_problem.updateConstrainTerm(
                m_num_samples * 9 + i, constrain_vec, -::boyle::math::kEpsilon,
                ::boyle::math::kEpsilon
            );
        }
        return;
