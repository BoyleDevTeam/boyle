...
RouteLineCubicAccModel::RouteLineCubicAccModel(std::vector<double> sample_ts) noexcept(
    !BOYLE_CHECK_PARAMS
) {
...
auto RouteLineCubicAccModel::setHardFences(std::span<const HardFence1d> hard_fences) noexcept
    -> void {
...
auto RouteLineCubicAccModel::setSoftFences(std::span<const SoftFence1d> soft_fences) noexcept
    -> void {
