...
class RouteLine final {
  ...
  public:
    ...
    RouteLine() noexcept = default;
    RouteLine(const RouteLine& other) noexcept = default;
    auto operator=(const RouteLine& other) noexcept -> RouteLine& = default;
    RouteLine(RouteLine&& other) noexcept = default;
    auto operator=(RouteLine&& other) noexcept -> RouteLine& = default;
    ~RouteLine() noexcept = default;
    ...
    explicit RouteLine(R&& anchor_points, param_type s0 = 0.0, const allocator_type& alloc = {})
    ...
    [[using gnu: pure, always_inline]]
    auto curvature(param_type s) -> param_type {
...
using RouteLine2s = RouteLine<::boyle::math::Vec2s>;

using RouteLine2d = RouteLine<::boyle::math::Vec2d>;
