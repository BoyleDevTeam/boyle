...
class [[nodiscard]] QpProblem final {
  ...
  private:
    ...
    ::boyle::math::DokMatrix<value_type, index_type> m_objective_matrix{};
    std::vector<value_type> m_objective_vector{};
    ::boyle::math::LilMatrix<value_type, index_type> m_constrain_matrix{};
    std::vector<value_type> m_lower_bounds{};
    std::vector<value_type> m_upper_bounds{};
};
