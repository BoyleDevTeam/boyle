...
template <::boyle::math::ScalarArithmetic Scalar = double, std::integral Index = int>
class [[nodiscard]] SparseMatrixFacade final : public pro::facade_builder
    ...
    ::template add_convention<m_updateCoeff, auto(std::size_t, std::size_t, const Scalar&) noexcept -> void>
