...
class PiecewiseCubicCurve final {
  ...
  public:
    ...
    [[using gnu: ]]
    explicit PiecewiseCubicCurve(
        std::span<const value_type> anchor_points, BoundaryMode<value_type> b0,
        BoundaryMode<value_type> bf, param_type s0 = 0.0, const allocator_type& alloc = {}
    ...
    [[using gnu: ]]
    explicit PiecewiseCubicCurve(
        [[maybe_unused]] periodic_tag tag, std::span<const value_type> anchor_points,
