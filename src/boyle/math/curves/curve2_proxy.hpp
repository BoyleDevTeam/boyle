...
class [[nodiscard]] Curve2Facade final : public pro::facade_builder
    ::template add_convention<pro::operator_dispatch<"()">, auto(U) const noexcept -> T, auto(U, U) const noexcept -> T, auto(SlDuplet<U>) const noexcept -> T>
    ::template add_convention<c_eval, auto(U) const noexcept -> T, auto(U, U) const noexcept -> T, auto(SlDuplet<U>) const noexcept -> T>
    ...
    ::template add_convention<c_inverse, auto(T) const noexcept -> ::boyle::math::SlDuplet<U>, auto(T, U, U) noexcept -> ::boyle::math::SlDuplet<U>>
