...
class [[nodiscard]] Curve2Facader final : public pro::facade_builder
...
using Curve2Proxy = pro::proxy<detail::Curve2Facader<T>>;

template <typename T>
[[using gnu: always_inline]]
inline auto makeCurve2Proxy(T curve2) -> Curve2Proxy<typename T::param_type> {
    return pro::make_proxy<detail::Curve2Facader<typename T::param_type>>(std::move(curve2));
}
