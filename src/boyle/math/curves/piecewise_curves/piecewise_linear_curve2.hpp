...
class [[nodiscard]] PiecewiseLinearCurve2 final {
  ...
  public:
    ...
    PiecewiseLinearCurve2(const PiecewiseLinearCurve2& other) noexcept = default;
    auto operator=(const PiecewiseLinearCurve2& other) noexcept -> PiecewiseLinearCurve2& = default;
    PiecewiseLinearCurve2(PiecewiseLinearCurve2&& other) noexcept = default;
    auto operator=(PiecewiseLinearCurve2&& other) noexcept -> PiecewiseLinearCurve2& = default;
    ~PiecewiseLinearCurve2() noexcept = default;
