...
class [[nodiscard]] PiecewiseCubicCurve2 final {
  ...
  public:
    ...
    PiecewiseCubicCurve2(const PiecewiseCubicCurve2& other) noexcept = default;
    auto operator=(const PiecewiseCubicCurve2& other) noexcept -> PiecewiseCubicCurve2& = default;
    PiecewiseCubicCurve2(PiecewiseCubicCurve2&& other) noexcept = default;
    auto operator=(PiecewiseCubicCurve2&& other) noexcept -> PiecewiseCubicCurve2& = default;
    ~PiecewiseCubicCurve2() noexcept = default;
