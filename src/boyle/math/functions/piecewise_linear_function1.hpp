...
class [[nodiscard]] PiecewiseLinearFunction1 final {
  ...
  public:
    ...
    auto operator=(const PiecewiseLinearFunction1& other) noexcept
        -> PiecewiseLinearFunction1& = default;
    PiecewiseLinearFunction1(PiecewiseLinearFunction1&& other) noexcept = default;
    auto operator=(PiecewiseLinearFunction1&& other) noexcept
        -> PiecewiseLinearFunction1& = default;
    ~PiecewiseLinearFunction1() noexcept = default;
...
using PiecewiseLinearFunction1s = PiecewiseLinearFunction1<float>;
