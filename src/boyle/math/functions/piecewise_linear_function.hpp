...
class PiecewiseLinearFunction final {
  ...
  public:
    ...
    PiecewiseLinearFunction(const PiecewiseLinearFunction& other) noexcept = default;
    auto operator=(const PiecewiseLinearFunction& other) noexcept
    ...
    explicit PiecewiseLinearFunction(const allocator_type& alloc) noexcept
        : m_ts(alloc), m_ys(alloc) {}

    [[using gnu: ]]
    explicit PiecewiseLinearFunction(
