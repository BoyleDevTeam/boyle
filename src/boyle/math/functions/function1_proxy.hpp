...
inline auto makeFunction1Proxy(T&& function1) -> Function1Proxy<
                                                  typename std::remove_reference_t<T>::value_type,
                                                  typename std::remove_reference_t<T>::param_type> {
    return pro::make_proxy<detail::Function1Facade<
        typename std::remove_reference_t<T>::value_type,
        typename std::remove_reference_t<T>::param_type>>(std::forward<T>(function1));
}
