...
template <ScalarArithmetic Scalar, ::boyle::math::MatrixOrder Order>
struct DensePartialPivotTrait<MatrixX<Scalar, Order>, ::boyle::math::MatrixOrder::COL_MAJOR> final {
    using type = VectorX<std::int32_t>;
};

template <ScalarArithmetic Scalar, ::boyle::math::MatrixOrder Order>
struct DensePartialPivotTrait<MatrixX<Scalar, Order>, ::boyle::math::MatrixOrder::ROW_MAJOR> final {
    using type = VectorX<std::int32_t>;
};
