...
#ifdef BOYLE_USE_AVX512
#include <immintrin.h>
#endif

#include "boost/serialization/complex.hpp"

#include "boyle/common/utils/in_in_in_result.hpp"
...
template <ScalarArithmetic T, typename Alloc>
class alignas(4 * sizeof(T)) Vector<T, 3, Alloc> final {
  public:
    ...
    Vector([[maybe_unused]] const allocator_type& alloc = {}) noexcept {}
    [[using gnu: always_inline]]
