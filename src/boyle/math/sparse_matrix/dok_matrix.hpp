...
class DokMatrix final {
  ...
  public:
    ...
    auto dictionary() const noexcept
        -> const boost::unordered_flat_map<IndexPair<Index>, Scalar, IndexPairHash<Index>>& {
        return m_dictionary;
    }
  ...
  private:
    ...
    boost::unordered_flat_map<IndexPair<Index>, Scalar, IndexPairHash<Index>> m_dictionary{};
};
