...
class [[nodiscard]] CscMatrix final {
  ...
  public:
    ...
    [[using gnu: flatten, leaf]] CscMatrix(const DokMatrix<Scalar, Index>& dok_matrix) noexcept
        ...
        const std::map<IndexPair<Index>, Scalar, IndexPairColumnMajorCompare<Index>>
