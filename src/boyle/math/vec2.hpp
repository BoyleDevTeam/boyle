...
struct Vec2 final {
    ...
    [[using gnu: pure, always_inline, leaf]]
    constexpr auto crossNorm(InstanceOfTemplate<Vec2> auto obj) const noexcept -> value_type {
    ...
    [[using gnu: pure, always_inline]]
    constexpr auto approachTo(InstanceOfTemplate<Vec2> auto obj, value_type tol = 1E-12)
        const noexcept -> bool {
