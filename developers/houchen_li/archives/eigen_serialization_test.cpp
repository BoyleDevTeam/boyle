...
TEST_CASE_TEMPLATE("DenseMatrixSerializationTest", T, Eigen::Matrix<double, kNumRows, kNumCols>, Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>) {
    T dense_matrix;
...
TEST_CASE_TEMPLATE("SparseCscMatrixSerializationTest", T, Eigen::SparseMatrix<double, Eigen::ColMajor, int>, Eigen::SparseMatrix<double, Eigen::RowMajor, int>) {
