...
- **high** — Found clear conventions, established patterns, and actionable guidelines
- **moderate** — Found partial conventions but some areas lack documentation
- **low** — Limited documentation or conventions; mostly inferred patterns
- **none** — No meaningful patterns or conventions found (very new or undocumented project)

## Token Budget

This research may be consumed by other agents (planning, onboarding). Keep output focused:

- Scoped invocation (1-2 phases): ~500-800 tokens
- Typical full scan: ~1200 tokens
- Rich results (large monorepo): cap at ~1800 tokens

Compress by tightening descriptions, not by dropping phases or findings.
