...
TEST_CASE("SemiCircle") {
    ...
    PiecewiseQuinticCurve2d semi_circle{anchor_points, b0, bf};
    ...
    for (double theta : intpl_thetas) {
        ...
        CHECK_EQ(sl.l, doctest::Approx(0.0).epsilon(kEpsilon));
        CHECK_EQ(semi_circle.curvature(sl.s), doctest::Approx(0.5).epsilon(kEpsilon));
    }
...
TEST_CASE("LogarithmicSpiral") {
    ...
    PiecewiseQuinticCurve2d log_spiral{anchor_points};
...
TEST_CASE("Serialization") {
    ...
    PiecewiseQuinticCurve2d other_log_spiral;
