...
if(BOYLE_USE_BLAS_LAPACK)
  ...
  if(CMAKE_C_COMPILER_ID STREQUAL "GNU" AND CMAKE_Fortran_COMPILER_ID STREQUAL "GNU")
    set(_OPENBLAS_ASMFLAGS ${CMAKE_C_FLAGS}\ ${CMAKE_C_FLAGS_RELEASE}\ -flto=auto\ -fno-fat-lto-objects)
    set(_OPENBLAS_CFLAGS ${CMAKE_C_FLAGS}\ ${CMAKE_C_FLAGS_RELEASE}\ -flto=auto\ -fno-fat-lto-objects)
    set(_OPENBLAS_FFLAGS ${CMAKE_Fortran_FLAGS}\ ${CMAKE_Fortran_FLAGS_RELEASE}\ -flto=auto\ -fno-fat-lto-objects)
  ...
  elseif(CMAKE_C_COMPILER_ID STREQUAL "Clang" AND CMAKE_Fortran_COMPILER_ID STREQUAL "LLVMFlang")
    set(_OPENBLAS_ASMFLAGS ${CMAKE_C_FLAGS}\ ${CMAKE_C_FLAGS_RELEASE}\ -flto=thin)
    set(_OPENBLAS_CFLAGS ${CMAKE_C_FLAGS}\ ${CMAKE_C_FLAGS_RELEASE}\ -flto=thin)
    set(_OPENBLAS_FFLAGS ${CMAKE_Fortran_FLAGS}\ ${CMAKE_Fortran_FLAGS_RELEASE}\ -flto=thin)
  ...
  elseif(CMAKE_C_COMPILER_ID STREQUAL "Clang" AND CMAKE_Fortran_COMPILER_ID STREQUAL "GNU")
    set(_OPENBLAS_ASMFLAGS ${CMAKE_C_FLAGS}\ ${CMAKE_C_FLAGS_RELEASE}\ -fno-lto)
    set(_OPENBLAS_CFLAGS ${CMAKE_C_FLAGS}\ ${CMAKE_C_FLAGS_RELEASE}\ -fno-lto)
    set(_OPENBLAS_FFLAGS ${CMAKE_Fortran_FLAGS}\ ${CMAKE_Fortran_FLAGS_RELEASE}\ -fno-lto)
    set(_OPENBLAS_LDFLAGS "-fuse-ld=gold")
    file(GLOB_RECURSE _GFORTRAN_LIBRARY
      "/usr/lib*/libgfortran.a"
      "/usr/lib*/libgfortran.so.[0-9]"
