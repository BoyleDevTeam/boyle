...
CPMAddPackage(
  NAME msft_proxy4
  VERSION 4.0.2
  URL https://github.com/ngcpp/proxy/releases/download/4.0.2/proxy-4.0.2.tgz
  URL_HASH SHA256=6e24ceaf9b6dfb65c9e0bdab7dd5cb27dc88959d8d210d5f81a6842143735370
  DOWNLOAD_ONLY True
)
include(${CMAKE_SOURCE_DIR}/cmake/msft_proxy4.cmake)
...
if(BOYLE_USE_BLAS_LAPACK STREQUAL "OpenBLAS")
  CPMAddPackage(
    ...
    GIT_TAG 18638c70eff1f0d08e2833b2724deaa128d6a334
    DOWNLOAD_ONLY True
  )
  if (WIN32)
    include(${CMAKE_SOURCE_DIR}/cmake/OpenBLAS.windows.cmake)
  elseif(APPLE)
    include(${CMAKE_SOURCE_DIR}/cmake/OpenBLAS.darwin.cmake)
  else()
    include(${CMAKE_SOURCE_DIR}/cmake/OpenBLAS.linux.cmake)
  endif()
endif()
