...
TEST_CASE_TEMPLATE("QuadraticTest", T, float, double, long double) {
    ::boyle::math::QuadraticMdFunction<::boyle::math::pmr::VectorX<T>> quadratic_mdfunction(
        2, ::boyle::common::pmr::getAlignedMemoryResource(32)
    );
    ...
    ::boyle::math::pmr::VectorX<T> x0(
        {0.0, -1.0}, ::boyle::common::pmr::getAlignedMemoryResource(32)
    );

    auto [result, info] = lnsrch_solver.solve(dense_problem, std::move(x0));
...
TEST_CASE_TEMPLATE("RosenBrockTest", T, float, double, long double) {
    ...
    ::boyle::math::pmr::VectorX<T> x0(
        {-1.0, 1.0}, ::boyle::common::pmr::getAlignedMemoryResource(32)
    );
