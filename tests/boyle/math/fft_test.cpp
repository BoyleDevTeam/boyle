...
TEST_CASE_TEMPLATE("FftTest", T, float, double, long double) {
    ...
    std::pmr::vector<std::complex<T>> result(
        data.size(), ::boyle::common::pmr::getAlignedMemoryResource(32)
    );
...
TEST_CASE_TEMPLATE("RfftTest", T, float, double, long double) {
    ...
    std::pmr::vector<std::complex<T>> result(
        data.size() / 2 + 1, ::boyle::common::pmr::getAlignedMemoryResource(32)
    );
...
TEST_CASE_TEMPLATE("IfftTest", T, float, double, long double) {
    ...
    std::pmr::vector<std::complex<T>> result(
        fft_data.size(), ::boyle::common::pmr::getAlignedMemoryResource(32)
    );
...
TEST_CASE_TEMPLATE("IrfftTest", T, float, double, long double) {
    ...
    std::pmr::vector<T> result(
        rfft_data.size() * 2 - 2, ::boyle::common::pmr::getAlignedMemoryResource(32)
    );
...
TEST_CASE_TEMPLATE("FftfreqTest", T, float, double, long double) {
    alignas(32) constexpr std::array<T, 8> expected_freq{0.0,  1.25,  2.5,  3.75,
                                                         -5.0, -3.75, -2.5, -1.25};
    std::pmr::vector<T> freq(8, ::boyle::common::pmr::getAlignedMemoryResource(32));
...
TEST_CASE_TEMPLATE("RfftfreqTest", T, float, double, long double) {
    ...
    std::pmr::vector<T> freq(8 / 2 + 1, ::boyle::common::pmr::getAlignedMemoryResource(32));
