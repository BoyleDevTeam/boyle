...
TEST_SUITE("Conversion") {
    TEST_CASE_TEMPLATE("FromCooMatrix", T, DokMatrix<double, int>, CscMatrix<double, int>, CsrMatrix<double, int>, LilMatrix<double, int>) {
    ...
    TEST_CASE_TEMPLATE("ToCooMatrix", T, DokMatrix<double, int>, CscMatrix<double, int>, CsrMatrix<double, int>, LilMatrix<double, int>) {
        T sparse_matrix(4, 8);
...
TEST_CASE("Serialization") {
    ...
    CHECK_EQ(other_coo_matrix.nnzs(), 3);
